...
ThisBuild / scmInfo := Some(
  ScmInfo(
    url("https://github.com/GrowingInTech/data-pipeline"),
    "scm:git@github.GrowingInTech/data-pipeline.git"
  )
)
...
ThisBuild / homepage := Some(url("https://github.com/GrowingInTech/data-pipeline"))
